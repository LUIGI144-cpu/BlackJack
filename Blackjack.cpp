...
int turnoBanco(string semiCarte[], int valoriCarte[], int puntiCarte[], bool cartaUscita[]) {
    ...
    cout << "TURNO DEL BANCO" << endl;


    cout << "Il Banco " << "pesca:" << endl;
    ...
    // il banco pesca finché il punteggio < 17
    while (punteggio < 17) {
		...
		//riduce il valore degli assi se sballa
        while (punteggio > 21 && assi > 0) {
            punteggio -= 10;
            assi--;
        }
...
int main() 
{
    ...
    do {
        ...
        int Banco = turnoBanco(semiCarte, valoriCarte, puntiCarte, cartaUscita);
